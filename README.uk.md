...
<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=cylinder&color=gradient&customColorList=0,2,6,12,20&height=200&section=header&text=🌐%20МОВНИЙ%20ПОРТАЛ&fontSize=42&fontColor=fff&animation=blinking&fontAlignY=38&desc=Виберіть%20Свою%20Реальність&descSize=18&descAlignY=60" width="100%" />
    ...
    <tr>
      ...
      <td align="center" width="16.66%">
        <a href="README.fr.md">
          ...
          <br />
          <img src="https://img.shields.io/badge/Live-ffff00?style=flat-square&labelColor=000000" alt="Live" />
        </a>
      </td>
      <td align="center" width="16.66%">
        <a href="README.ru.md">
          ...
          <br />
          <img src="https://img.shields.io/badge/Live-ff6600?style=flat-square&labelColor=000000" alt="Live" />
        </a>
      </td>
      <td align="center" width="16.66%">
        <a href="README.uk.md">
          ...
          <br />
          <img src="https://img.shields.io/badge/Active-0066ff?style=flat-square&labelColor=000000" alt="Active" />
        </a>
      </td>
    </tr>
  </table>
...
<div align="center">
  <br />
  <img src="https://readme-typing-svg.herokuapp.com?font=Roboto&weight=700&size=48&duration=2500&pause=800&color=38bdf8&center=true&vCenter=true&width=800&height=120&lines=Алі+Харб;AlizHarb+%7C+HarbzAli+%7C+AzH;Повний+Стек+Інженер;Архітектура+Надійності;Створення+Цифрових+Вражень" alt="Typing SVG" />
  
  <h3 style="color: #94a3b8; font-family: 'Roboto', sans-serif; font-weight: 400; letter-spacing: 1px;">
    ІНЖЕНЕР-ПРОГРАМІСТ ПОВНОГО СТЕКУ
  </h3>

  <p style="color: #cbd5e1; max-width: 600px; line-height: 1.6;">
    Я створюю системи, які <b>масштабуються</b>, та інтерфейси, які <b>захоплюють</b>. Спеціалізуюся на екосистемі PHP, поєднуючи складну серверну логіку з плавними фронтенд-взаємодіями.
  </p>
